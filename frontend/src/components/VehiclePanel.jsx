  ...
  return (
    <div>
      ...
      onClick={()=>{
        ...
        className="flex border-2 border-gray-200 focus-within:border-black mb-2 rounded-xl w-full p-3 items-center justify-between transition-all"
        tabIndex="0"
      >
        <img
          className="h-10"
      ...
      >
        ...
        <h2 className="text-lg font-semibold">₹118.69</h2>
      </div>
    </div>
  );
};
